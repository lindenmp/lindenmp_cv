...
\cvitem{}{\emph{Citations = 730, h-index = 13, i10-index = 16}}}
...
{\begin{itemize}
  \item NeuroImage, Human Brain Mapping, Network Neuroscience, Scientific Reports, Biological Psychiatry, Psychological Medicine, Neuropsychologia, NeuroImage: Clinical, Psychiatry Research: Neuroimaging, Harvard Review of Psychiatry, International Gambling Studies, Journal of Cerebral Blood Flow \& Metabolism
\end{itemize}
}
